...
import '../create_room_screen.dart'; // 실제 경로에 맞춰 수정하세요
import '../services/camera_test_screen.dart'; // 실제 경로에 맞춰 수정하세요
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // 💡 SafeArea와 SingleChildScrollView로 감싸서 화면 밖으로 나가는 에러를 방지합니다.
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 40), // 💡 Spacer 대신 SizedBox를 써서 간격을 조절합니다.
              ...
              _MainButton(
                ...
                onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => CreateRoomScreen())),
              ),
              const SizedBox(height: 14),
              _MainButton(
                text: '방 참가하기',
              ...
              _MainButton(
                ...
                backgroundColor: Colors.white,
                textColor: textHeadingColor,
                onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const CameraTestScreen())),
              ),
