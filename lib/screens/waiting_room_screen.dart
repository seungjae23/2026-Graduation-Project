    ...
    return Scaffold(
      ...
      body: StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          ...
          // 게임 시작 상태라면 화면 이동 (참가자 없으면 '테스트 2P' 삽입)
          if (status == 'playing') {
            WidgetsBinding.instance.addPostFrameCallback((_) {
              _moveToGameIfNeeded(
                hostNickname: hostNickname,
                guestNickname: hasGuest ? guestNickname : '테스트 2P',
              );
            });
          }
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 28),
                  _PrimaryButton(
                    text: widget.isHost ? (isStartingGame ? '게임 시작 중...' : '게임 시작하기') : '방장이 게임을 시작하기를 기다리는 중',
                    icon: widget.isHost ? Icons.play_arrow : Icons.hourglass_top,
                    enabled: widget.isHost && !isStartingGame,
                    onTap: _startGame,
                  ),
                ],
              ),
