        ...
        if res.hand_landmarks:
            for landmarks in res.hand_landmarks:
                ...
                for i, lm in enumerate(landmarks):
                    print(f"Point {i:02d}: x={lm.x:.4f}, y={lm.y:.4f}, z={lm.z:.4f}")
