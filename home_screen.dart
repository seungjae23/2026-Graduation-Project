        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // 버튼들
              _MainButton(
                text: '방 만들기', icon: Icons.add, backgroundColor: const Color(0xFF6C63FF), textColor: Colors.white,
                onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const CreateRoomScreen())),
              ),
              const SizedBox(height: 14),
              _MainButton(text: '방 참가하기', icon: Icons.login, backgroundColor: Colors.white, textColor: const Color(0xFF2E2E3A), onTap: () {}),
              const SizedBox(height: 14),
              _MainButton(text: '카메라 테스트', icon: Icons.camera_alt, backgroundColor: Colors.white, textColor: const Color(0xFF2E2E3A), onTap: () {}),
